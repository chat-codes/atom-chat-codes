...
import { AtomEditorWrapper } from './atom-state-tracker';
...
export class AtomCommunicationService extends EventEmitter {
    constructor(userName) {
        super();
        this.commService = new CommunicationService(true, userName, CREDENTIALS.key, CREDENTIALS.cluster, AtomEditorWrapper);
